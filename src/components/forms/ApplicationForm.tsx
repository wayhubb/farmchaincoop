...
import { useRouter } from "next/navigation"; // ✅ preferred over window.location for navigation in Next.js
...
export default function ApplicationForm() {
  const router = useRouter(); // ✅ safer client-side navigation
      ...
      return (
        <div style={{ color: forestGreen, marginTop: 16 }}>
          ...
          <button
            ...
            type="button"
            onClick={() => router.push("/membership")} // ✅ replaces window.location.href
          >
      ...
      <form onSubmit={handleSubmit} autoComplete="off">
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          {errors.monthlyIncome && (
            <div style={{ color: "crimson", fontSize: 13 }}>{errors.monthlyIncome}</div>
          )}
        </div>
